...
public class AnimalEstimacao {
    ...
    @JsonIgnore // esta anotação faz com que o campo não vá para o JSON
    @Column(length = 50_000_000) // 50 Mb (megabytes)
    //@Column(length = 50 * 1024 * 1024)
    private byte[] foto; // o tamanho do campo é a quantidade em bytes
