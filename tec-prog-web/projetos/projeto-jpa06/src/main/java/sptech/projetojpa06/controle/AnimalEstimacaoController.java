...
public class AnimalEstimacaoController {
    ...
    // Aqui deixamos explicito o tipo de dado que pode ser enviado na requisição
    // no caso, imagens (image/jpeg)
    ...
    public ResponseEntity patchFoto(@PathVariable long codigo,
        ...
        repository.atualizarFoto(codigo, novaFoto);

        return ResponseEntity.status(200).build();
    }

    // Aqui deixamos explicito o tipo de dado que pode ser enviado na RESPOSTA
    // no caso, imagens (image/jpeg)
    ...
    public ResponseEntity patchEndereco(@PathVariable long codigo,
