...
insert into tipo_animal (descricao) values('Gato'),('Cachorro'),('Hamster');

insert into animal_estimacao
(castrado, cpf_dono, data_nascimento, email_dono, nome, peso, telefone_dono, tipo_codigo)
values
(false, '45750262049', '2020-09-09', 'aaaa@bbb', 'xuxu', 2.5, '9999-9999', 2),
...
(false, '99988800012', '2019-01-01', 'wwqqq@eee', 'xuxu', 4.0, '9999-9999', 1);
